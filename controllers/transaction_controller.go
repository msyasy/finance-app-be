...
func CreateTransaction(c *gin.Context) {
	var input models.TransactionInput // Menggunakan struct dari package models
	...
	// Ambil teks catatan (fleksibel mendukung "note" maupun "notes")
...
// 3. GET TRANSACTIONS (PAGINATION + DATE RANGE FILTER)
...
// 4. GET MONTHLY CASH FLOW (6 BULAN TERAKHIR)
